...
public class StringUtils {
	 ...
	 * inner simple dots.
	 * <p>The response is convenient for path comparison. For other uses,
...
//		response.addAll(Arrays.asList(array1));
...
//			response[i] = (element != null ? element.trim() : null);
//		}
//		return response;
//	}
...
//				continue;
//			}
//			response.setProperty(splittedElement[0].trim(), splittedElement[1].trim());
//		}
//		return response;
//	}
	 ...
	 * @param ignoreEmptyTokens omit empty tokens from the response array
...
//	}
	...
	public static int getNumber(String content){
		...
		int res = Integer.valueOf(m.replaceAll("").trim());
		return res;
	}
	// 按照这样的格式进行解析：jdbc:datasong://localhost:3306/javademo?user=root&password=123456&characterEncoding=UTF8
	public static String getUrl(String jdbcStr){
		String temp = jdbcStr.substring(("jdbc:datasong://").length());
		return temp.substring(0, temp.indexOf(":"));
	}
	public static String getPort(String jdbcStr){
		String temp = jdbcStr.substring(("jdbc:datasong://").length());
		return temp.substring(temp.indexOf(":")+1, temp.indexOf("/"));
	}
	public static String getDatabase(String jdbcStr){
		String temp = jdbcStr.substring(("jdbc:datasong://").length());
		return temp.substring( temp.indexOf("/")+1, temp.indexOf("?"));
	}
	public static String getUser(String jdbcStr){
		String temp = jdbcStr.substring(jdbcStr.indexOf("?")+1);
		String[] strList = temp.split("&");
		return strList[0].split("=")[1];
	}
	public static String getPassword(String jdbcStr){
		String temp = jdbcStr.substring(jdbcStr.indexOf("?")+1);
		String[] strList = temp.split("&");
		return strList[1].split("=")[1];
	}
	public static String getEncoding(String jdbcStr){
		String temp = jdbcStr.substring(jdbcStr.indexOf("?")+1);
		String[] strList = temp.split("&");
		return strList[2].split("=")[1];
	}
}
